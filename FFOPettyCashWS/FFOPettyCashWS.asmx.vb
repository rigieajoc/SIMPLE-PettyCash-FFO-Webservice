        ...
        Try
            ...
            If dtconvert.Rows.Count > 0 Then
                ...
                If dtwrap.Rows.Count > 0 Then
                    ...
                    ElseIf code = myTransactCode.CPostFundLiquidation Then  'post_fundliquidation
                        traceline = "4"
                        retvalarry = clsData.UploadFundLiquidation(employeeid, dtwrap)
                        moddescription = "Fund Liquidation"
                    ...
                    ElseIf code = myTransactCode.CPostExpenseReport Then    'post_expensereport
                        traceline = "7"
                        retvalarry = clsData.UploadExpenseReport(employeeid, dtwrap)
                        moddescription = "Expense Report"

                    ElseIf code = myTransactCode.CPostFundReleasedCashTransfer Then 'post_fundreleased_cashtransfer
                        traceline = "8"
                        retvalarry = clsData.UploadFundReleasedCashTransfer(employeeid, dtwrap)
                        moddescription = "Fund Released - Cash Transfer"
...
#Region "Method - Wrap"
    Private Function WrapDataTable(ByVal dt As DataTable, ByVal transtype As myTransactCode) As DataTable
        ...
        Try
            If transtype = myTransactCode.CPostFundReleased Then    'post_fundreleased
                dtnew.Columns.Add("frid", GetType(Long))                '0
                dtnew.Columns.Add("frno", GetType(Long))                '1
                dtnew.Columns.Add("frno_ffo", GetType(Long))            '2
                dtnew.Columns.Add("cashinid", GetType(Long))            '3
                dtnew.Columns.Add("payeeid", GetType(Long))             '4
                dtnew.Columns.Add("payee", GetType(String))             '5
                dtnew.Columns.Add("institutionid", GetType(Long))       '6
                dtnew.Columns.Add("institutionname", GetType(String))   '7
                dtnew.Columns.Add("mode", GetType(Long))                '8
                dtnew.Columns.Add("tuprefno", GetType(String))          '9
                dtnew.Columns.Add("fundtypeid", GetType(Long))          '10
                dtnew.Columns.Add("checkno", GetType(String))           '11
                dtnew.Columns.Add("checkdate", GetType(DateTime))       '12
                dtnew.Columns.Add("amount", GetType(Decimal))           '13
                dtnew.Columns.Add("panelid", GetType(Long))             '14
                dtnew.Columns.Add("remarks", GetType(String))           '15
                dtnew.Columns.Add("status", GetType(Long))              '16
                dtnew.Columns.Add("ffo_frid", GetType(String))          '17
                dtnew.Columns.Add("createdbyid", GetType(Long))         '18
                dtnew.Columns.Add("datecreated", GetType(DateTime))     '19
                dtnew.Columns.Add("updatedbyid", GetType(Long))         '20
                dtnew.Columns.Add("dateupdated", GetType(DateTime))     '21
                dtnew.Columns.Add("approvedbyid", GetType(Long))        '22
                dtnew.Columns.Add("dateapproved", GetType(DateTime))    '23
                dtnew.Columns.Add("syncstatus", GetType(Boolean))       '24
                dtnew.Columns.Add("syncdate", GetType(DateTime))        '25
                dtnew.Columns.Add("dlsyncstatus", GetType(Boolean))     '26
                dtnew.Columns.Add("dlsyncdate", GetType(DateTime))      '27
                dtnew.Columns.Add("mainsyncstatus", GetType(Boolean))   '28
                dtnew.Columns.Add("mainsyncdate", GetType(DateTime))    '29
                ...
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    rw(2) = 0
                    rw(3) = 0
                    rw(4) = dt.Rows(i).Item("payeeid")
                    rw(5) = dt.Rows(i).Item("payee")
                    rw(6) = dt.Rows(i).Item("institutionid")
                    rw(7) = dt.Rows(i).Item("institutionname")
                    rw(8) = dt.Rows(i).Item("mode")
                    rw(9) = dt.Rows(i).Item("tuprefno")
                    rw(10) = dt.Rows(i).Item("fundtypeid")
                    rw(11) = dt.Rows(i).Item("checkno")
                    rw(12) = dt.Rows(i).Item("checkdate")
                    rw(13) = dt.Rows(i).Item("amount")
                    rw(14) = dt.Rows(i).Item("warehouseid")
                    rw(15) = dt.Rows(i).Item("remarks")
                    rw(16) = 0
                    rw(17) = dt.Rows(i).Item("frid_ffo")
                    rw(18) = dt.Rows(i).Item("createdbyid")
                    rw(19) = dt.Rows(i).Item("dateencoded")
                    rw(20) = dt.Rows(i).Item("approvedbyid") 'updatedbyid
                    rw(21) = "1/1/1900"
                    rw(22) = dt.Rows(i).Item("approvedbyid")
                    rw(23) = dt.Rows(i).Item("dateencoded")
                    rw(24) = False
                    rw(25) = "1/1/1900"
                    rw(26) = False
                    rw(27) = "1/1/1900"
            ...
            ElseIf transtype = myTransactCode.CPostExpenseReport Then    'post_expensereport
                ...
                dtnew.Columns.Add("ffo_expensereportid", GetType(String))   '25
                ...
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    rw(14) = dt.Rows(i).Item("updatedbyid")
                    rw(15) = dt.Rows(i).Item("dateencoded")
                    rw(16) = 0
                    rw(17) = "1/1/1900"
                    rw(18) = False
                    rw(19) = "1/1/1900"
                    ...
                    rw(23) = "1/1/1900"
                    rw(24) = 0
                    rw(25) = dt.Rows(i).Item("ffo_expensereportid")
